package com.raf.user.service.secutiry;
...
public class SecurityAspect {
    ...
    @Around("@annotation(com.raf.user.service.secutiry.CheckSecurity)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        com.raf.user.service.secutiry.CheckSecurity checkSecurity = method.getAnnotation(com.raf.user.service.secutiry.CheckSecurity.class);
